...
app.post('/generate-pdf', async (req, res) => {
    try {
        ...
        // Reduz a assinatura do solicitante para 25% do tamanho original
        const solicSignatureDims = solicSignatureImage.scale(0.25);
        ...
        const repSignatureDims = repSignatureImage.scale(0.25); // Reduz a assinatura do representante para 25%
